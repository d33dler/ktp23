...
function MainForm() {
    ...
    const [built_in_appliances, set_built_in_appliances] = useState('');
    ...
    const handleSubmit = async (e) => {
        ...
        const idk = {
air_quality : "average",
apartment_facing:  "sunset",
area_sqm:  "10",
balcony_access:  "yes",
built_in_appliances:  "yes",
community_facilities:  "yes",
distance_from_airport:  "15",
distance_from_bike_rental:  "1",
distance_from_bus_station:  "2",
distance_from_car_rental:  "3",
distance_from_ferry:  "10",
distance_from_gym:  "5",
distance_from_highway:  "5",
distance_from_hospital:  "8",
distance_from_library:  "5",
distance_from_park:  "2",
distance_from_pharmacy:  "1",
distance_from_public_transportation:  "1",
distance_from_recreation_area:  "5",
distance_from_schools:  "3",
distance_from_shopping_center:  "2",
distance_from_shops:  "2",
distance_from_taxi_stand:  "1",
distance_from_touristic_area:  "3",
distance_from_train_station:  "3",
distance_from_zoo:  "10",
distance_to_city:  "2",
earthquake_risk:  "yes",
elevator:  "yes",
energy_label:  "B",
...
furnished:  "yes",
garden:  "yes",
garden_or_terrace:  "yes",
internet:  "yes",
jacuzzi:  "yes",
landlord_tenant_ages:  "16-60",
landscaping:  "yes",
lawn:  "yes",
living_capacity:  "1",
living_room:  "private",
...
nearby_disturbances:  "yes",
parking_availability:  "private",
parking_space:  "garage",
pets_allowed:  "yes",
pool:  "yes",
population:  "1E6",
problematic_neighbors:  "yes",
property_location:  "Rotterdam",
property_type:  "room",
quality_of_construction:  "high",
renovation_date:  "8",
roommates:  "2",
sauna:  "yes",
security:  "yes",
...
view:  "city",
        ...
        console.log(data);
        try {
            const response = await axios.post('http://127.0.0.1:8000', idk);
...
<>
<Form.Label as='h1'>Area Sqm</Form.Label>
...
,
<>
<Form.Label as='h1'>Property Location</Form.Label>
...
,
<>
<Form.Label as='h1'>Distance To City</Form.Label>
...
,
<>
<Form.Label as='h1'>Population</Form.Label>
...
,
<>
<Form.Label as='h1'>Property Type</Form.Label>
...
,
<>
<Form.Label as='h1'>Furnished</Form.Label>
...
,
<>
<Form.Label as='h1'>Shower</Form.Label>
...
,
<>
<Form.Label as='h1'>Toilet</Form.Label>
...
,
<>
<Form.Label as='h1'>Living Room</Form.Label>
...
,
<>
<Form.Label as='h1'>Living Capacity</Form.Label>
...
,
<>
<Form.Label as='h1'>Internet</Form.Label>
...
,
<>
<Form.Label as='h1'>Energy Label</Form.Label>
...
,
<>
<Form.Label as='h1'>Roommates</Form.Label>
...
,
<>
<Form.Label as='h1'>Problematic Neighbors</Form.Label>
...
,
<>
<Form.Label as='h1'>Air Quality</Form.Label>
...
,
<>
<Form.Label as='h1'>Nearby Disturbances</Form.Label>
...
,
<>
<Form.Label as='h1'>Apartment Facing</Form.Label>
...
,
<>
<Form.Label as='h1'>Balcony Access</Form.Label>
...
,
<>
<Form.Label as='h1'>Pets Allowed</Form.Label>
...
,
<>
<Form.Label as='h1'>Landlord Tenant Ages</Form.Label>
...
,
<>
<Form.Label as='h1'>Near Public Transportation</Form.Label>
...
,
<>
<Form.Label as='h1'>Parking Availability</Form.Label>
...
,
<>
<Form.Label as='h1'>Garden Or Terrace</Form.Label>
...
,
<>
<Form.Label as='h1'>Distance From Schools</Form.Label>
...
,
<>
<Form.Label as='h1'>Distance From Hospital</Form.Label>
...
,
<>
<Form.Label as='h1'>Security</Form.Label>
...
,
<>
<Form.Label as='h1'>Management Fee</Form.Label>
<Form.Control as="radio" placeholder="Enter the Management Fee" onChange={(e) => set_management_fee(e.target.value)}>
<Form.Check type="radio" label="Yes" value="yes" name="group-26"/>
<Form.Check type="radio" label="No" value="no" name="group-26"/>
</Form.Control>
</>
,
<>
<Form.Label as='h1'>Quality Of Construction</Form.Label>
...
,
<>
<Form.Label as='h1'>Renovation Date</Form.Label>
...
,
<>
<Form.Label as='h1'>Flood Risk</Form.Label>
...
,
<>
<Form.Label as='h1'>Earthquake Risk</Form.Label>
...
,
<>
<Form.Label as='h1'>Distance From Shops</Form.Label>
...
,
<>
<Form.Label as='h1'>Distance From Gym</Form.Label>
...
,
<>
<Form.Label as='h1'>Sound Proof</Form.Label>
<Form.Control as="radio" placeholder="Enter the Sound Proof" onChange={(e) => set_sound_proof(e.target.value)}>
...
,
<>
<Form.Label as='h1'>Storage</Form.Label>
...
,
<>
<Form.Label as='h1'>Built In Appliances</Form.Label>
...
,
<>
<Form.Label as='h1'>Elevator</Form.Label>
...
,
<>
<Form.Label as='h1'>Pool</Form.Label>
...
,
<>
<Form.Label as='h1'>Sauna</Form.Label>
...
,
<>
<Form.Label as='h1'>Jacuzzi</Form.Label>
...
,
<>
<Form.Label as='h1'>Spa</Form.Label>
...
,
<>
<Form.Label as='h1'>Community Facilities</Form.Label>
...
,
<>
<Form.Label as='h1'>Distance From Touristic Area</Form.Label>
...
,
<>
<Form.Label as='h1'>Parking Space</Form.Label>
...
,
<>
<Form.Label as='h1'>Distance From Public Transportation</Form.Label>
...
,
<>
<Form.Label as='h1'>Distance From Highway</Form.Label>
...
,
<>
<Form.Label as='h1'>Distance From Airport</Form.Label>
...
,
<>
<Form.Label as='h1'>Distance From Train Station</Form.Label>
...
,
<>
<Form.Label as='h1'>Distance From Bus Station</Form.Label>
...
,
<>
<Form.Label as='h1'>Distance From Ferry</Form.Label>
<Form.Control as="radio" placeholder="Enter the Distance From Ferry" onChange={(e) => set_distance_from_ferry(e.target.value)}>
...
,
<>
<Form.Label as='h1'>Distance From Taxi Stand</Form.Label>
...
,
<>
<Form.Label as='h1'>Distance From Bike Rental</Form.Label>
...
,
<>
<Form.Label as='h1'>Distance From Car Rental</Form.Label>
...
,
<>
<Form.Label as='h1'>Lawn</Form.Label>
...
,
<>
<Form.Label as='h1'>Landscaping</Form.Label>
...
,
<>
<Form.Label as='h1'>Garden</Form.Label>
...
,
<>
<Form.Label as='h1'>Distance From Park</Form.Label>
...
,
<>
<Form.Label as='h1'>Distance From Recreation Area</Form.Label>
...
,
<>
<Form.Label as='h1'>Distance From Zoo</Form.Label>
...
,
<>
<Form.Label as='h1'>View</Form.Label>
...
,
<>
<Form.Label as='h1'>Security Features</Form.Label>
...
,
<>
<Form.Label as='h1'>Distance From Shopping Center</Form.Label>
...
,
<>
<Form.Label as='h1'>Distance From Library</Form.Label>
...
,
<>
<Form.Label as='h1'>Distance From Pharmacy</Form.Label>
    ...
    return (
        <Container>
            ...
            <ButtonGroup style={{display: 'flex', justifyContent: 'center'}}>
                <Button className="mb-3 me-2" size='lg' disabled={prevDisabled} variant="primary" onClick={prevStep}>Previous</Button>
                <Button className="mb-3 me-2" size='lg' disabled={nextDisabled} variant="primary" onClick={nextStep}>Next</Button>
            </ButtonGroup>
            <ButtonGroup>
                <Button className="mb-3 me-2" size='lg' type="submit" disabled={!showSubmit} variant="primary">Submit</Button>
            </ButtonGroup>
            </Form>
        </Container>
    )
